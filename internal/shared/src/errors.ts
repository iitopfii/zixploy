...
export const ERROR_CODES = {
  ...
  // service backups (phase 16)
  SERVICE_BACKUP_NOT_FOUND: 404,
  SERVICE_BACKUP_NOT_READY: 409,
  SERVICE_BACKUP_FAILED: 500,
  SERVICE_RESTORE_FAILED: 500,
  ...
  // multi-container projects / components (phase 18)
  COMPONENT_NOT_FOUND: 404,
  COMPONENT_DUPLICATE_NAME: 409,
  COMPONENT_INVALID: 422,
  COMPONENT_DEP_INVALID: 422,
  PROJECT_NOT_COMPOSE: 409,
  COMPOSE_PROMOTE_INVALID: 422,
